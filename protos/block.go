...
func (block *Block) Bytes() ([]byte, error) {
	...
	fmt.Printf("\nprotos/block.go Block Bytes data : %s\n", data)
	if err != nil {
...
func (block *Block) GetHash() ([]byte, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("Could not calculate hash of block: %s\n", err)
	}
	blockCopy, err := UnmarshallBlock(blockBytes)
	fmt.Printf("block.go GetHash blockcopy = %s\n",blockCopy)
	if err != nil {
	...
	fmt.Printf("block.go GetHash data = %s\n",data)
	...
	fmt.Printf("block.go GetHash hash = %x\n",hash)
	return hash, nil
}
...
func UnmarshallBlock(blockBytes []byte) (*Block, error) {
	block := &Block{}
	fmt.Printf("protos/block.go UnmarshallBlock blockBytes: %s\n", blockBytes)
